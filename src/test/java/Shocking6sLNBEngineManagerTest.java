...
public class Shocking6sLNBEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Shocking6sLNBEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Shocking6sLNBIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Shocking6sLNBIW/InitOutcome.xml").getDocumentElement();
